...
//   DECELERATED_SPEED  ↓ Caps 정밀 이동 더 느리게(글자 단위)
...
#define MOUSEKEY_DELAY 5               // QMK 기본 5
...
#define MOUSEKEY_DECELERATED_SPEED 400 // QMK 기본 400 (Caps 정밀 이동)
#define MOUSEKEY_ACCELERATED_SPEED 3000// QMK 기본 3000
