...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN1] = LAYOUT_69_ansi(
        ...
        _______, BT_HST1,  BT_HST2,  BT_HST3, P2P4G,   _______, MS_BTN1,MS_UP,MS_BTN2,_______,_______, _______,  _______,  _______,          KC_INS,
        UG_TOGG, UG_NEXT,  UG_VALU,  UG_HUEU, UG_SATU, UG_SPDU,          MS_LEFT, MS_DOWN, MS_RGHT, _______,  _______,  _______,  _______,          KC_END,
        _______,           UG_PREV, UG_VALD, UG_HUED, UG_SATD, UG_SPDD,  _______, NK_TOGG, _______, _______,  _______,  _______,  _______, KC_PGUP,
        _______, _______,  _______,           MO(WHEEL),        _______,  _______,          _______,           _______,            _______, KC_PGDN, _______),
