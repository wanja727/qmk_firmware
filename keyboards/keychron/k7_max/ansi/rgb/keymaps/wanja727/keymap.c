...
[MAC_BASE] = LAYOUT_ansi_68(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                            LT(MOUSE, KC_SPC),                        KC_RCMMD, MO(MAC_FN1),MO(MAC_FN1),KC_LEFT,KC_DOWN, KC_RGHT),
...
[WIN_BASE] = LAYOUT_ansi_68(
     ...
     MO_NAV,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,            KC_PGUP,
     KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,                      KC_RSFT,  KC_UP,   KC_PGDN,
     KC_LCTL,  KC_LGUI,  KC_LALT,                             LT(MOUSE, KC_SPC),                        KC_RALT,  MO(WIN_FN1),MO(WIN_FN1),KC_LEFT,KC_DOWN, KC_RGHT),
